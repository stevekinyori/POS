...
export class ProductsService {
    ...
    /**
     * Convert a returned JSON object to Products.
     */
    private convertItemFromServer(json: any): Products {
        const entity: Products = Object.assign(new Products(), json);
        return entity;
    }

    /**
     * Convert a Products to a JSON which can be sent to the server.
     */
